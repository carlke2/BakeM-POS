    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="h-10 w-10 flex items-center justify-center rounded-full bg-[#E8F6EC] text-[#148A32] font-semibold text-lg">
            {name.charAt(0).toUpperCase()}
          </div>
          <div>
            <h1 className="text-base font-semibold text-gray-800 flex items-center gap-1">
              <TitleIcon size={18} className="text-[#39B54A]" />
              {title}
            </h1>
        ...
        <motion.button
          ...
          className="flex items-center gap-2 bg-[#39B54A] text-white px-4 py-2 rounded-lg hover:bg-[#39B54A]/90 transition-all duration-200 shadow-sm"
        >
          <LogOut size={18} />
