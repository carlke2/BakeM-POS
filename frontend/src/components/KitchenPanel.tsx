          ...
          return (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div>
                  <h4 className="font-extrabold text-[#B91D2D] text-lg">{dish.name}</h4>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-center">
                <div className="bg-slate-50 rounded-xl p-2.5">
                  ...
                  <p className="text-sm font-black text-[#B91D2D]">{dish.canCookBatches} batches</p>
                </div>
                <div className="bg-[#FBF4D0] rounded-xl p-2.5">
                  <p className="text-[9px] text-[#5C0101] font-bold uppercase">Ready (POS)</p>
                  <p className="text-sm font-black text-[#5C0101]">{dish.portionsReady}</p>
                </div>
                <div className="bg-[#FBF4D0] rounded-xl p-2.5">
                  <p className="text-[9px] text-[#B91D2D] font-bold uppercase">Sales made</p>
                  <p className="text-sm font-black text-[#5C0101]">KES {sold.toLocaleString()}</p>
                </div>
              ...
              {expected > 0 && (
                <div>
                  ...
                  <div className="h-2.5 bg-slate-100 rounded-full overflow-hidden">
                    <div
                      className="h-full bg-[#B91D2D] rounded-full transition-all duration-500"
