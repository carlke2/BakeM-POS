    ...
    <div className="p-4 md:p-8 bg-[#FBF4D0] min-h-screen font-sans space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <div className="bg-white rounded-2xl p-5 border border-gray-100">
          <div className="flex items-center gap-3">
            <Users className="text-[#5C0101]" size={24} />
            <div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-gray-100">
          <div className="flex items-center gap-3">
            <UtensilsCrossed className="text-[#B91D2D]" size={24} />
            <div>
        ...
        <div className="bg-white rounded-2xl p-5 border border-gray-100">
          <div className="flex items-center gap-3">
            <DollarSign className="text-[#5C0101]" size={24} />
            <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-2xl p-6 border border-gray-100">
          <h3 className="font-bold text-[#B91D2D] mb-4">Financial Summary</h3>
          <div className="space-y-3">
            <div className="flex justify-between items-center p-3 bg-[#FBF4D0] rounded-xl">
              <span className="flex items-center gap-2 text-sm"><TrendingUp size={16} className="text-[#5C0101]" /> Sales</span>
              <span className="font-bold text-[#5C0101]">KES {finance.revenue.toLocaleString()}</span>
            </div>
            ...
            <div className="flex justify-between items-center p-3 bg-[#FBF4D0] rounded-xl">
              ...
              <span className={`font-bold ${finance.netProfit >= 0 ? "text-[#5C0101]" : "text-red-600"}`}>KES {finance.netProfit.toLocaleString()}</span>
            </div>
          </div>
        </div>

        <div className="bg-white rounded-2xl p-6 border border-gray-100">
          <h3 className="font-bold text-[#B91D2D] mb-4">Staff by Role</h3>
